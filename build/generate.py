...
CORE_PAGES = [
    ...
    {
        "path": "devis-gratuit",
        "content": "devis-gratuit.html",
        "title": "Devis gratuit pare-brise en 30 secondes | Cadeaux Pare-Brise",
        "description": "Obtenez votre devis gratuit et sans engagement pour le remplacement de votre pare-brise. Vérification de votre prise en charge assurance en 30 secondes.",
        "priority": "0.8",
    },
    {
        "path": "calibrage-adas",
        "content": "calibrage-adas.html",
        "title": "Calibrage ADAS après remplacement de pare-brise | Cadeaux Pare-Brise",
        "description": "Le calibrage des aides à la conduite (ADAS) après remplacement de pare-brise : pourquoi c'est obligatoire, comment ça marche, inclus sans supplément.",
        "priority": "0.7",
    },
    {
        "path": "prix-pare-brise",
        "content": "prix-pare-brise.html",
        "title": "Prix d'un pare-brise : combien ça coûte vraiment | Cadeaux Pare-Brise",
        "description": "Prix d'un remplacement de pare-brise, fourchettes indicatives, et ce que vous payez réellement une fois votre assurance et votre offre appliquées.",
        "priority": "0.8",
    },
    {
        "path": "pare-brise-urgence",
        "content": "pare-brise-urgence.html",
        "title": "Pare-brise en urgence : que faire ? | Cadeaux Pare-Brise",
        "description": "Pare-brise fissuré ou brisé ? Les bons réflexes immédiats et notre intervention rapide sous 24-48h dans le Nord Pas-de-Calais.",
        "priority": "0.7",
    },
    {
